                    ...
                    <form wire:submit="save" class="mt-4">
                        <div class="p-6">
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" wire:model='name' class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Input text">
                            </div>
                            <div class="mb-4">
                            ...
                            <input type="hidden" name="tableNumber" id='tableNumber' wire:model="tableNumber">
                        </div>
                        <!-- Modal Footer -->
